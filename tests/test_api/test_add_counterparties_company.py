from src.endpoint import CounterpartyEndpoints
...
class TestAddCounterpaties:
    ...
    def test_add_mandatory_fields(self, hosts, dict_for_test, registration_type):
        ...
        add_counterpaties = post(hosts['endpoint'], CounterpartyEndpoints.add_counterpaties_endpoint, hosts['tokens']['token'],
                                 dict_for_test)
    ...
    def test_add_CounterpartyEndpoints_without_company_id(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_int_company_id(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_int_company_no_access(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_fullname(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_fullname_130k(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_fullname_object_already_exists(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_registration_type(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_registration_type_enums(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_business_relations(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_business_relations_masive(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_business_relations_array_field(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_business_relations_invalid_type(self, hosts, dict_for_test):
        dict_for_test['business_relations'] = ["dss"]
        add_counterpaties = post(hosts['endpoint'], CounterpartyEndpoints.add_counterpaties_endpoint, hosts['tokens']['token'],
                                 dict_for_test)
    ...
    def test_add_CounterpartyEndpoints_without_identify_number(self, hosts, dict_for_test):
        dict_for_test['identify_number'] = None
        add_counterpaties = post(hosts['endpoint'], CounterpartyEndpoints.add_counterpaties_endpoint, hosts['tokens']['token'],
                                 dict_for_test)
        assert add_counterpaties.status_code == 200

    def test_add_CounterpartyEndpoints_with_identify_number_301sumbols(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_phone(self, hosts, dict_for_test):
        dict_for_test['phone'] = None
        add_counterpaties = post(hosts['endpoint'], CounterpartyEndpoints.add_counterpaties_endpoint, hosts['tokens']['token'],
                                 dict_for_test)
        assert add_counterpaties.status_code == 200

    def test_add_CounterpartyEndpoints_with_phone_301sumbols(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_phone_type_field(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_address(self, hosts, dict_for_test):
        dict_for_test['address'] = None
        add_counterpaties = post(hosts['endpoint'], CounterpartyEndpoints.add_counterpaties_endpoint, hosts['tokens']['token'],
                                 dict_for_test)
        assert add_counterpaties.status_code == 200

    def test_add_CounterpartyEndpoints_with_address_301sumbols(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_without_email(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_email_301sumbols(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_email_field(self, hosts, dict_for_test):
    ...
    def test_add_CounterpartyEndpoints_with_note(self, hosts, dict_for_test):
